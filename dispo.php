...
require_once("class_dispo.php");
		...
		if(isset($_POST['ok'])){
				...
				$obj=new Dispo($_POST['idv'],$_POST['dd'],$_POST['dr'],$_POST['dis'],$_POST['nom']);
				$obj->ajouter();
				header('Location: detail_voit.php?id='.$_POST['idv'].'.php');
    ...
    <div id="page-wrapper"><!-- MAIN CONTENT-->
        <div class="main-content"><!-- CONTENT-->
            <div class="content">
                <div class="section background-opacity page-title set-height-top">
                    <div class="container">
                        <div class="page-title-wrapper"><!--.page-title-content--><h2 class="captions"></h2>
                            <ol class="breadcrumb">
                                <li><a href="index.php">Home</a></li>
                                <li ><a href="">voiture</a></li>
								<li class="active"><a href="#">Allouer voiture</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" >
            <fieldset>
				...
				<div>
                    <input type="text" name="idv" value="<?php echo $_GET['id']; ?>" hidden />
                </div>
				<div>
				...
				<div>
                    <input type="text" name="dis" value="1" hidden />
                </div>
				<div>
                    <input type="text" name="nom" value="<?php echo $_SESSION['nom']; ?>" hidden />
                </div>
