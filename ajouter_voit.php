<?php
		...
		if(isset($_POST['ok'])){
			...
			$liste=voiture::recherche_voitm($_POST['mat']);
			
			if($liste[1] != $_POST['mat']){
				$obj=new voiture($_POST['mat'],$_POST['mar'],$_POST['p'],$_POST['nb'],$_POST['typeb'],$_POST['prix'],$_POST['date'],$location,$_POST['type']);
				$obj->ajouter();
            ...
            <div class="topbar-right pull-right">
				...
				if(!isset($_SESSION['login']) ){
					...
					if($_SESSION['type']=="Admin"){
						...
						<a href="lister.php" class="register">List Des Membres</a>
    ...
    <div id="page-wrapper"><!-- MAIN CONTENT-->
                    ...
                    <div class="container">
                        <div class="page-title-wrapper"><!--.page-title-content--><h2 class="captions">Toutes les Voitures</h2>
                            <ol class="breadcrumb">
								...
								<li class="active"><a href="#">Ajouter voiture</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="courses-wrapper"><!-- Nav tabs-->
                            <div class="row top-content">
                                <div class="col-md-3">
                                    <div class="result-output text-left"><p class="result-count">Nombres de Voitures <strong>
									<?php require_once('voit.php');$liste=voiture::lister(); 
                                    echo count($liste); ?>
									</strong> </p></div>
                                </div>
                                <div class="col-md-6">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            <fieldset>
                ...
                <div>
                    <input type="text" name="mat" placeholder="matricule"/>
                </div>
				<div>
                    <input type="text" name="mar" placeholder="marque"/>
                </div>
				<div>
                    <input type="text" name="p" placeholder="puissance"/>
                </div>
				<div>
                    <input type="text" name="nb" placeholder="nbr place"/>
                </div>
				<div>
                    <input type="text" name="typeb" placeholder="type boite"/>
                </div>
				<div>
