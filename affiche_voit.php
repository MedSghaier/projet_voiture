                                ...
                                <div class="col-md-6">
                                   <?php
                                    ...
                                    echo '<ul role="tablist" class="nav nav-tabs edugate-tabs">
                                        ...
                                        <li role="presentation"><a href="affiche_voit_ts.php"  class="text">Lister Voiture</a></li>
									</ul>';
									}else{
									 echo '<ul role="tablist" class="nav nav-tabs edugate-tabs">
                                        <li role="presentation"><a href="affiche_voit_ts.php"  class="text">Lister Voiture</a></li>
									...
									require_once('voit.php');
											...
											if($cle<4){
                                                ...
                                                <div class="edugate-layout-2-wrapper">
                                                    <div class="edugate-content"><a href="courses-detail.html" class="title">'.$valeur[2].'</a>
                                                        ...
                                                        <div class="description">Matricule :'.$valeur[1].' <br>Puissnace fiscal : '.$valeur[3].'<br>
